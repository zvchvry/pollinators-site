...
const togglePlay = () => {
  ...
  <div className="banner"><img
    ...
    <div className="desc">
      <>
      <p>Immerse yourself in a captivating world of the graceful pollinators. Flower Banners is an NFT project expanding on the <a href='https://market.pollinators.art/explore/ETHEREUM:0x644baae5c9e497cbca266c70d7d3a0efb61f9cd1' target='_blank' rel="noreferrer" >The Pollinators</a> collection. Combining breathtaking flower photographs with the delicate dance of the pollinators, these unique banners offer an enchanting celebration of nature&apos;s wonders.</p>
...
<br />
<p>
Check out the Pollinators Market or Sudoswap for secondary sales.</p>

<div className="banner"><a href='https://market.pollinators.art' target="_blank" rel="noreferrer"><img
          src="https://itsnota.club/pllntrs/market-ad.png"
          alt="Pollinators Market"
        /></a>
        </div>
        <div className="banner"><a href='https://sudoswap.xyz/#/browse/buy/0xd6d503f0f788f3c2d553be0b5460ba4e2798044d' target="_blank" rel="noreferrer"><img
          src="https://itsnota.club/pllntrs/fb-sudoswap.png"
          alt="Flower Banners on Sudoswap"
        /></a>
        </div>
